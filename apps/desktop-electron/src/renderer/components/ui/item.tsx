...
const itemVariants = cva(
  "group/item flex w-full flex-wrap items-center rounded-lg border text-sm outline-none transition-colors duration-100 focus-visible:border-ring focus-visible:ring-1 focus-visible:ring-ring/40 [a]:transition-colors [a]:hover:bg-muted [button]:transition-colors [button]:hover:bg-muted aria-current:bg-muted aria-selected:bg-muted aria-pressed:bg-muted",
  {
    variants: {
      variant: {
